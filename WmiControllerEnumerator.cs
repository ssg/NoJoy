...
internal class WmiControllerEnumerator
{
    ...
    private class DeviceInfo
    {
        ...
        {
#pragma warning disable CA1507 // Use nameof to express symbol names: no correspondence between the two
            ...
            DeviceId = result["DeviceId"].ToString() ?? String.Empty;
...
#pragma warning restore CA1507 // Use nameof to express symbol names
    ...
    public static MainWindowViewModel GetControllers()
    {
